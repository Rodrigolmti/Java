...
public class InclusaoPassagens {
   		...
   		System.out.println(" ***************  INCLUSAO DE PASSAGENS AÉREAS  ***************** ");
    		do{
    			...
    			if (posicaoRegistro >= 0) {
   					System.out.println("Código inválido, utilize outro 'Código em uso'!");
    			}
	...
	public static String validaComp (String nomeCiaAerea) {//Metodo para fazer validação de companhia aerea
