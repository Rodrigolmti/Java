...
public class CadSocios {
	...
	public static ArrayList<Socio> pesqSocioNome(String nome) throws SocioException{
		...
		if (resposta.size() > 0) {
			...
			throw new SocioException("Não existe sócio para o nome.");
		}
