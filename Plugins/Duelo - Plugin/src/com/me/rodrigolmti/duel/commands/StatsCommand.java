...
public class StatsCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        player.sendMessage(border + ChatColor.DARK_AQUA + "  Vitorias: " + ChatColor.GRAY + wins);
        player.sendMessage(border + ChatColor.DARK_AQUA + "  Derrotas: " + ChatColor.GRAY + losses);
        player.sendMessage(border + ChatColor.DARK_AQUA + "  TIES: " + ChatColor.GRAY + ties);
        player.sendMessage(border + ChatColor.GOLD + "--------------------");
        player.sendMessage(border + ChatColor.DARK_AQUA + "  KDR: " + ChatColor.GRAY + ratio);
        player.sendMessage(border + ChatColor.GOLD + "--------------------");
        return true;
    }
