...
public final class UserManager {
    private final static Map<String, DuelPlayer> players = new HashMap<>();
    ...
    private static DuelPlayer retrieveDuelPlayer(String playerName, boolean offlineValid) {
        ...
        if (DuelPlayer == null) {
            ...
            if (player == null) {
                if (!offlineValid) {
                    Duel.p.getLogger().log(Level.WARNING, "A valid DuelPlayer object could not be found for {0}.", playerName);
                }
